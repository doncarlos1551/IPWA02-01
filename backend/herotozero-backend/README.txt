...
a persistence unit "herotozero-backendPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "herotozero-backend/pom.xml":
...
artifact ("herotozero-backend.war") is already built. You can build
